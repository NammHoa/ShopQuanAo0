...
import com.example.shopquanao.Activity.DetailActivity;
...
public class PopularListAdapter extends RecyclerView.Adapter<PopularListAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull PopularListAdapter.Viewholder holder, int position) {
        ...
        holder.txtFee.setText("đ"+items.get(position).getPrice());
 ...
 TextView txtTitle, txtScore, txtFee;
 ImageView IVPic1;
        public Viewholder(@NonNull View itemView) {
            super(itemView);
            txtTitle=itemView.findViewById(R.id.txtTitle);
            txtFee=itemView.findViewById(R.id.txtFee);
            txtScore=itemView.findViewById(R.id.txtScoreHolder);
